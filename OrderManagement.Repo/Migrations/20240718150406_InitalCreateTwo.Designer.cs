...
namespace OrderManagement.Repo.Migrations
{
    ...
    [Migration("20240718150406_InitalCreateTwo")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "93c5e9d7-423e-43ab-b5b2-58d4d6c8092b",
                            ConcurrencyStamp = "ce9fd8cd-b3e6-4757-baaf-3f0b1c10157b",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = "3d028381-9152-4b35-af08-e61fc2ed68c4",
                            ConcurrencyStamp = "60813ec5-89ae-40b7-ad52-5ed5a95976e1",
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("OrderManagement.Core.Entities.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            InvoiceId = 1,
                            InvoiceDate = new DateTime(2024, 7, 18, 18, 4, 6, 293, DateTimeKind.Local).AddTicks(4401),
                            OrderId = 1,
                            TotalAmount = 10.97m
                        },
                        new
                        {
                            InvoiceId = 2,
                            InvoiceDate = new DateTime(2024, 7, 18, 18, 4, 6, 293, DateTimeKind.Local).AddTicks(4403),
                            OrderId = 2,
                            TotalAmount = 5.98m
                        });
                });
            ...
            modelBuilder.Entity("OrderManagement.Core.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 7, 18, 18, 4, 6, 293, DateTimeKind.Local).AddTicks(4321),
                        ...
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2024, 7, 18, 18, 4, 6, 293, DateTimeKind.Local).AddTicks(4360),
